...
This work is still licensed under a Creative Commons Attribution-NoDerivatives 3.0 Unported License ([CC BY-ND 3.0](http://creativecommons.org/licenses/by-nd/3.0/)), isn't under a All Rights Reserved (because of [this](https://wiki.creativecommons.org/wiki/Considerations_for_licensors_and_licensees#Remember_the_license_may_not_be_revoked))
...
* Relevant forks:
	+ [net-lisias-kspu](net-lisias-kspu/Taerobee)
